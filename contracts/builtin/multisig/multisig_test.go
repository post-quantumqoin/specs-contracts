...
import (
	...
	multisig "github.com/post-quantumqoin/specs-contracts/contracts/builtin/multisig"
...
func TestChangeThreshold(t *testing.T) {
	...
	testCases := []thresholdTestCase{
		...
		// TODO missing test case that needs definition: hgithub.com/post-quantumqoin/specs-contracts/issues/71
